  ...
  return (
    <>
      ...
      >
        <div className="px-8 md:px-24 w-full grid md:grid-cols-2 items-center">
          ...
          <div className="hidden md:flex flex-col items-end text-right space-y-12">
            ...
            <div>
              ...
              <p className="text-xl text-neutral-400 font-light">concierge@mypropertyattorneys.com</p>
            </div>
        ...
        {/* Corner Detail */}
        <div className="absolute bottom-12 left-8 md:left-24 text-[9px] font-black uppercase tracking-[0.5em] text-neutral-800 uppercase">
          my property attorneys
        </div>
      </div>
    </>
  );
